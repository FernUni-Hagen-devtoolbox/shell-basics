...
Für schnelle Änderungen an den Notebooks und Ressourcen gibt es jetzt ein kleines Makefile. Der lokale Workflow baut das Image und startet JupyterLab mit dem Repository gemountet, sodass Sie Änderungen sofort im Browser sehen können.
...
Der Browser öffnet dann JupyterLab mit den Inhalten aus `lesson-content/` als Startverzeichnis. Wenn Sie nur eine Shell im Image brauchen, verwenden Sie `make shell`.